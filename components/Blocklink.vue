      ...
      <div class="row">
                ...
                <div class="post-desc-wrapper">
                  <div class="post-desc">
                    <div class="post-title">
                      <h6 class="heading-regular">
                        <a href="#"
                          >Alumni Service Spotlight: Larry Traimor AB '82</a
                        >
                      </h6>
                    </div>
                    <div class="post-excerpt">
                ...
                <div class="company-desc-wrapper">
                  <div class="company-desc">
                    <div class="company-title">
                      <h6 class="heading-regular">
                        <a href="#">Creative Director at StartTrek Inc</a>
                      </h6>
                    </div>
                ...
                <div class="company-desc-wrapper">
                  <div class="company-desc">
                    <div class="company-title">
                      <h6 class="heading-regular">
                        <a href="#"
                          >Chief Technologies Officer at Microtek Inc</a
                        >
                      </h6>
                    </div>
                    <div class="company-excerpt">
              ...
              <div class="company-item clearfix">
                ...
                <div class="company-desc-wrapper">
                  <div class="company-desc">
                    <div class="company-title">
                      <h6 class="heading-regular">
                        <a href="#">Senior UI/UX Manager at Kidos Inc</a>
                      </h6>
                    </div>
                    <div class="company-excerpt">
                      <p>
              ...
              <div class="company-item clearfix">
                ...
                <div class="company-desc-wrapper">
                  <div class="company-desc">
                    <div class="company-title">
                      <h6 class="heading-regular">
                        <a href="#">Finance Officer at Atomic Inc</a>
                      </h6>
                    </div>
                    <div class="company-excerpt">
                      <p>
        ...
        <div class="block-event-calendar col-md-4 col-sm-12 col-xs-12">
          <div class="column-calendar">
                    ...
                    <div class="date-desc">
                      ...
                      <div class="place">
                        ...
                        <span class="text-place"
                          >Gondomanan Street 209, California</span
                        >
                      </div>
                    </div>
                  </div>
            ...
            <div class="view-all">
              <a href="./programs-events.html">View All Events</a>
            </div>
          </div>
        </div>
      </div>
