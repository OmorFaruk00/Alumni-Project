        ...
        <div class="container">
            <div class="row event-row">
                <div class="area-img col-md-5 col-sm-12 col-xs-12">
                    <img class="img-fluid" src="images/even-img.jpg" alt=""/>
                </div>
                        ...
                        <div class="row">
                            <div class="col-sm-10 col-xs-9">
                                ...
                                <h6 class="mb-3 mt-3 text-justify">
                                    ...
                                    quisquam consequuntur veniam molestias enim officiis expedita, culpa unde!
                                </h6>
                                <span>
                                    <span class="icon map-icon"></span>
                                    <span class="text-place text-dark animated fadeInRight">
                                        Street, Gondomanan, 8993, San Francisco, CA</span >
                                </span>
                            </div>
                            ...
                            <nuxt-link to="#" class="home-btn mt-4 ml-2 mr-3">JOIN NOW</nuxt-link >
                            <nuxt-link to="/event" class="home-btn mt-4 ml-2">ALL EVENTS</nuxt-link >
                        </div>
                    </div>
                </div>
            </div>
