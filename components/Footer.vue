      ...
      <div class="container">
              ...
              <div class="contact-footer">
                <div class="logo-footer">
                  <a href="./homepage-1.html"
                    ><img src="images/diulogo.png" alt=""
                  /></a>
                </div>
                <div class="contact-desc">
                  <p class="">
                    Dhaka International University, rated among the top private
                    universities of Bangladesh. <br /><br />is an institution
                    that promotes eastern culture and values, and meaningfully
                    blends eastern and western thoughts and innovation.
                  </p>
                </div>
                <div class="contact-phone-email">
                  <span class="contact-phone"
                    ><a href="#">+10872229</a> | <a href="#">+10872228 </a>
                  </span>
                  <span class="contact-email"
                    ><a href="#">alumni@diu.edu</a></span
                  >
                </div>
              </div>
            </div>
        ...
        <div class="footer-bottom text-center">
          <p class="copyright text-light">
            © 2022 DIU. All rights Reserved. | Developed & Powered by: IT-Team,
            DIU
          </p>
        </div>
      </div>
