    ...
    <div id="demo" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="images/slider1.jpg" alt="Los Angeles" width="2100" height="700">
                    <div class="carousel-caption">
                        <div class="container">
                            <div class="content-block">
                                <h2 class="text-center">
                                    <span class="text-white">Hearty Welcomes with
                                    </span>
                                    <br/>
                ...
                <div class="carousel-item">
                    ...
                    <div class="carousel-item">
                        <img src="images/slider3.jpg" alt="New York" width="2100" height="700">
                            <div class="carousel-caption">
                                <div class="container">
                                <div class="content-block">
                                    <h2>
