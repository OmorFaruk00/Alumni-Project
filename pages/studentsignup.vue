                                    ...
                                    <div class="row">
                                        <div class="col-sm-12 col-md-6 col-lg-4">
                                            <div class="form-outline mb-2">
                                                <label class="form-label mb-2" for="form3Example1cg">Useranme</label >
                                                <input
                                                    type="text"
                                                    id="form3Example1cg"
                                                    class="form-control"
                                        ...
                                        <div class="col-sm-12 col-md-6 col-lg-4">
                                            <div class="form-outline mb-2">
                                                <label class="form-label mb-2" for="form3Example1cg">Password</label >
                                                <input
                                                    type="text"
                                                    id="form3Example1cg"
                                                    class="form-control"
                                        ...
                                        <div class="col-sm-12 col-md-6 col-lg-4">
                                            <div class="form-outline mb-2">
                                                <label class="form-label mb-2" for="form3Example1cg">Confirm Password
                                                </label>
                                                <input
                                                    type="text"
                                                    id="form3Example1cg"
                                    ...
                                    <hr>
                                        ...
                                        <hr>
                                            ...
                                            <div class="d-flex mb-4">
                                                <h6 class="mr-3">Do you like to help Diu alumni
