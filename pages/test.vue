                ...
                <form>
                  ...
                  <!-- <div class="mobile-form-wrapper pb-3">
                    ...
                    <div class="input-group control-group input-wrapper">
                      ...
                      <div class="input-group-btn">
                        <button
                          class="btn btn-info mobile-add-button"
                          type="button"
                        >
                          <i class="fa fa-plus"></i>
                          Add
                  ...
                  <!-- <div class="email-form-wrapper">
                    ...
                    <div class="input-group control-group input-wrapper">
                      ...
                      <div class="input-group-btn">
                        <button
                          class="btn btn-info email-add-button"
                          type="button"
                        >
                          <i class="fa fa-plus"></i>
                          Add
                  ...
                  <div class="form-outline mb-2">
                    <label class="form-label mb-2 mt-3" for="form3Example1cg"
                  ...
                  <!-- <div class="job-form-wrapper">
                    <div class="row">
                      ...
                      <div class="col-sm-12 col-md-12 col-lg-12 d-flex">
                        <button
                          class="btn btn-info job-add-button ml-auto"
                          type="button"
                        >
                          <i class="fa fa-plus"></i>
                          Add
...
export default {
  ...
  mounted() {
    ...
    this.name = alumni.data.name;
    this.batch = alumni.data.batch;
